...
export function ImageWithOverlay() {
    ...
    const handleMouseMove = (e: React.MouseEvent) => {
        if (hover) {
            // Calculate position relative to the container (the parent Frame)
            const frameRect = e.currentTarget.getBoundingClientRect()
            setPosition({
                x: e.clientX - frameRect.left - 0, // Adjust x position within the container
                y: e.clientY - frameRect.bottom - 100, // Adjust y position within the container
            })
        }
    }
    ...
    return (
        ...
        >
            ...
            <Frame
                ...
                style={{
                    position: "absolute",
                    bottom: position.y + "px", // Position overlay relative to the container
                    left: position.x + "px", // Position overlay relative to the container
                    zIndex: 1,
                    borderRadius: "15px",
